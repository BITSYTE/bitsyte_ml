...
@endsection
   ...
   @section('scripts')
        ...
        <script type="text/javascript" src="{{ asset('backoffice/app-assets/vendors/js/charts/jquery.sparkline.js')}}"></script>
        <script src="{{ asset('backoffice/app-assets/vendors/js/extensions/jquery.knob.js')}}" type="text/javascript"></script>
        <script src="{{ asset('backoffice/app-assets/js/scripts/extensions/knob.js')}}" type="text/javascript"></script>
        <script src="{{ asset('backoffice/app-assets/vendors/js/charts/raphael-min.js')}}" type="text/javascript"></script>
        <script src="{{ asset('backoffice/app-assets/vendors/js/charts/morris.js')}}" type="text/javascript"></script>
        <script src="{{ asset('backoffice/app-assets/vendors/js/charts/jvector/jquery-jvectormap-2.0.3.js')}}" type="text/javascript"></script>
        <script src="{{ asset('backoffice/app-assets/vendors/js/charts/jvector/jquery-jvectormap-world-mill.js')}}" type="text/javascript"></script>
        <script src="{{ asset('backoffice/app-assets/data/jvector/visitor-data.js')}}" type="text/javascript"></script>
        <script src="{{ asset('backoffice/app-assets/vendors/js/charts/chart.js')}}" type="text/javascript"></script>
        <script src="{{ asset('backoffice/app-assets/vendors/js/charts/jquery.sparkline.js')}}" type="text/javascript"></script>
  ...
  <body data-open="click" data-menu="horizontal-menu" data-col="1-column" class="horizontal-layout horizontal-menu 1-column  blank-page blank-page">
    ...
    <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1  box-shadow-2 p-0">
        <div class="card border-grey border-lighten-3 m-0">
            ...
            <div class="card-footer">
                <div class="">
                    <p class="float-sm-left text-xs-center m-0"><a href="{{ url('/recover-password') }}" class="card-link">Recover password</a></p>
                    <p class="float-sm-right text-xs-center m-0">New to BitSyte? <a href="{{ url('/register') }}" class="card-link">Sign Up</a></p>
                </div>
            </div>
        </div>
    ...
    <!-- //////////////////////////////////////-->
@endsection
>>>>>>> parent of 08a4075... separacion de carpetas
