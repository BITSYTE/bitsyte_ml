...
<html lang="{{ config('app.locale') }}" data-textdirection="ltr" >
  <head>
    ...
    @section('styles')
          ...
          <link rel="stylesheet" type="text/css" href="{{ asset('app-assets/fonts/flag-icon-css/css/flag-icon.css')}}">
          ...
          <link rel="stylesheet" type="text/css" href="{{ asset('app-assets/vendors/css/weather-icons/climacons.css')}}">
          <!-- END VENDOR CSS-->
          <!-- BEGIN STACK CSS-->
  ...
  <body data-open="click" data-menu="vertical-menu" data-col="1-column" class="vertical-layout vertical-menu 1-column  blank-page blank-page">
    ...
    @section('scripts')
        <!-- BEGIN VENDOR JS-->
        <script src="{{ asset('app-assets/vendors/js/vendors.js')}}" type="text/javascript"></script>
        <!-- BEGIN VENDOR JS-->
        <!-- BEGIN PAGE VENDOR JS-->
        <script type="text/javascript" src="{{ asset('app-assets/vendors/js/ui/jquery.sticky.js')}}"></script>
        <script type="text/javascript" src="{{ asset('app-assets/vendors/js/charts/jquery.sparkline.js')}}"></script>
        <script src="{{ asset('app-assets/vendors/js/extensions/jquery.knob.js" type="text/javascript')}}"></script>
        <script src="{{ asset('app-assets/js/scripts/extensions/knob.js" type="text/javascript')}}"></script>
        <script src="{{ asset('app-assets/vendors/js/charts/raphael-min.js" type="text/javascript')}}"></script>
        <script src="{{ asset('app-assets/vendors/js/charts/morris.js" type="text/javascript')}}"></script>
        <script src="{{ asset('app-assets/vendors/js/charts/jvector/jquery-jvectormap-2.0.3.js')}}" type="text/javascript"></script>
        ...
        <script src="{{ asset('app-assets/vendors/js/charts/chart.js')}}" type="text/javascript"></script>
        <script src="{{ asset('app-assets/vendors/js/charts/jquery.sparkline.js')}}" type="text/javascript"></script>
