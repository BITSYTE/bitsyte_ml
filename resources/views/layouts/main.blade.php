                ...
                <ul class="nav navbar-nav float-xs-right">
                    <li class="dropdown dropdown-user nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="{{ route('admin.index') }}" class="dropdown-item"><i class="ft-layout"></i>Administrator</a>
        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="nav navbar-nav">
            ...
            <li data-menu="dropdown" class="dropdown nav-item">
                ...
                <ul class="dropdown-menu">
                    <li data-menu=""><a href="{{ route('trees.binary') }}" data-toggle="dropdown" class="dropdown-item">Binary</a></li>
                    <li data-menu=""><a href="{{ route('trees.unilevel') }}" data-toggle="dropdown" class="dropdown-item">Unilevel</a></li>
                </ul>
            </li>
...
<footer class="footer navbar-fixed-bottom footer-light navbar-shadow ">
    ...
    <div class="md-fab-wrapper md-fab-speed-dial">
        ...
        <div class="md-fab-wrapper-small ">
            ...
            <a class="md-fab md-fab-small md-fab-danger" href="{{ route('users.create') }}" data-uk-tooltip="{cls:'uk-tooltip-small',pos:'left'}" title="New user">
